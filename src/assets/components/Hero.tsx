...
const Hero = () => {
  return (
    <section className="text-gray-900 h-screen w-full flex flex-col justify-center gap-5 sm:flex sm:gap-10">
      <div className="">
        <div className="w-full flex justify-center gap-10 xl:hero-img">
      ...
      <RentalInfoCard className="hidden" />
    </section>
  );
};
